...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="configName" label="请求URL">
      </el-table-column>
      <el-table-column sortable prop="configValue" label="请求方式">
      </el-table-column>
      <el-table-column sortable prop="remark" label="请求参数">
      </el-table-column>
      <el-table-column sortable prop="remark" label="操作IP">
      </el-table-column>
      <el-table-column sortable prop="remark" label="用户代理">
      </el-table-column>
      ...
      <el-table-column :show-overflow-tooltip="true" sortable prop="remark" label="错误信息" width="255">
          <template slot-scope="scope">
            <div class="linkDialog" @click="errorInfoClick(scope.row)">{{scope.row.remark}}</div>
          </template>
       </el-table-column>
    </el-table>
    <!-- 分页组件 -->
